...
if [ -n "$help" ];then
    cat <<'EOF'
Gak Pake Lama Drupal AutoInstaller Variation 1

Usage:
  gpl-drupal-variation1.sh --project-name=<name>
  gpl-drupal-variation1.sh --project-name=<name> --domain=<domain>
  gpl-drupal-variation1.sh --project-parent-name=<parent> \
    --project-name=<name> \
    --domain=<domain> \
    --drupal-version='^9'
...
Options:
  ...
  --project-name              Set the project name, it will populate variable
                              $project_name.
  --project-parent-name       Set the project parent name, it will populate
                              variable $project_parent_name.
  --domain                    Add other domain to nginx server_name directive.
                              If omit, default is "${project_name}.localhost".
  --drupal-version            Set the version of Drupal. The value will be
                              passed to Composer. Example: '^9', '^10.1'
...
magenta 'drupal_version="'$drupal_version'"'
____
...
if [ -n "$notfound" ];then
    ...
    magenta composer create-project --no-install drupal/recommended-project . $drupal_version
